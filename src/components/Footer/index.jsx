...
const Footer = () => {
  return (
    <footer>
      <a
        href="https://www.youtube.com/channel/UCP3F-tR0G_5rDD5QKsrjYCw"
        target="_blank"
      >
        <img
      ...
      <a href="https://www.facebook.com/heri.s.aji.12" target="_blank">
        <img
          src="https://github.com/DwinaTech/public-images/blob/main/facebook-con.png?raw=true"
          alt="YouTube-icon"
        />
      </a>
      <a href="https://twitter.com/heriaji21" target="_blank">
        <img
